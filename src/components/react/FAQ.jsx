    ...
    <section id="faq" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-bold text-slate-900 mb-4">Ответы на ваши вопросы</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Собрали важные ответы о бронировании, проживании, номерах, парковке и отдыхе у моря в Джубге.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-slate-600 mb-6">
            Напишите или позвоните нам: ответим на вопрос, поможем подобрать номер и подскажем актуальные условия бронирования.
          </p>
